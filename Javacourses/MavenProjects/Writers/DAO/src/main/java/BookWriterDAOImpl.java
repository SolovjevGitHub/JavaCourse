...
public class BookWriterDAOImpl implements IWriterDAO {
    private static Logger logger=LoggerSingletone.getInstance().getLogger(BookWriterDAOImpl.class.getName());
    ...
    public void delete(Integer id) {
        try(Connection connection=ConnectionSingletone.getInstance().getConnection()){
    ...
    public void insert(BookWriter entity) {
        try(Connection connection=ConnectionSingletone.getInstance().getConnection()){
            ...
            logger.info("ERROR in BookWriterDAOIpl insert-method");
        }
        catch (Exception ex){
            ex.printStackTrace();
        }
